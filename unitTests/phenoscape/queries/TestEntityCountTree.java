...
public class TestEntityCountTree {
	...
	@Test
	public void testEntityCountTree() {
		EntityCountTree testTree = new EntityCountTree(TAOUID,u);
...
//		}
		System.out.println("TAO/CARO table size = " + countQueryTAO.ontologyTable.size());
	}

	@Test
	public void testBuild() throws Exception {
		countQueryTAO.build(u,taxonProfiles, geneProfiles);
		System.out.println("GrandTotal table size = " + countQueryTAO.getGrandTotal().size());
	}
