...
public class TestSimilarityCalculator {
	...
	@Test
	public void testCollectionIntersectionSize() throws SQLException{
		...
		int result = testEntityCalculator.collectionIntersectionSize(testTaxonEntities, testGeneEntities);
		System.out.println("taxon Entities = {1}; gene Entities = {2}");
		...
		System.out.println("taxon Entities = {1,1}; gene Entities = {2}");
		System.out.println("IntersectionSize = " + result);
		...
		testEntityCalculator = new SimilarityCalculator<Integer>(2933);
		result = testEntityCalculator.collectionIntersectionSize(testTaxonEntities, testGeneEntities);
		System.out.println("taxon Entities = {1,1}; gene Entities = {1}");
		System.out.println("IntersectionSize = " + result);
		...
		testEntityCalculator = new SimilarityCalculator<Integer>(2933);
		result = testEntityCalculator.collectionIntersectionSize(testTaxonEntities, testGeneEntities);
		System.out.println("taxon Entities = {1}; gene Entities = {2,3}");
		System.out.println("IntersectionSize = " + result);
